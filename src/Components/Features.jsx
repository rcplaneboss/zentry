...
const BentoTilt = ({ children, className = "" }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const tiltX = ( relativeY - .5 ) * 10;
        const tiltY = ( relativeX - .5 ) * 10;
...
return <div className={className} ref={itemRef} onMouseLeave={handleMouseLeave} onMouseMove={handleMouseMove} style={{transform: transformStyle}}>{children}</div>;
};
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Immerse yourself in a rich and evr-expanding universe where a
